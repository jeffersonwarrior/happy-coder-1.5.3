        ...
        options={{
          ...
          headerRight: () => (
            <View style={{ flexDirection: 'row' }}>
              <Pressable onPress={handleEdit} style={{ padding: 8, marginRight: 8 }} disabled={isDeleting}>
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.titleContainer}>
            <Text style={[styles.title, !artifact.title && styles.untitledTitle]}>{artifact.title || 'Untitled'}</Text>
