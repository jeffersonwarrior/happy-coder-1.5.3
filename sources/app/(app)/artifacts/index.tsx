      ...
      return (
        ...
        >
          <View style={styles.artifactContent}>
            <Text style={[styles.artifactTitle, !item.title && styles.artifactUntitled]} numberOfLines={1}>
              {item.title || 'Untitled'}
            </Text>
            <View style={styles.artifactMeta}>
              <Text style={styles.artifactDate}>{new Date(item.updatedAt).toLocaleDateString()}</Text>
            </View>
          </View>
          <Ionicons
  ...
  const ListEmptyComponent = React.useCallback(() => {
    ...
    return (
      <View style={styles.emptyContainer}>
        <Ionicons name="document-text-outline" size={64} style={styles.emptyIcon} color={theme.colors.textSecondary} />
