    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>iOS System Colors</Text>
        ...
        {/* Component Colors */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>Component Colors</Text>
...
const groupedBackground = '#F2F2F7';`}
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>NativeWind Classes</Text>
