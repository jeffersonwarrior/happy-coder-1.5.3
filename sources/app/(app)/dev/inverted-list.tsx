      ...
      <Animated.View style={[styles.container, { transform: [{ translateY: height }] }]}>
        <View style={styles.controlsContainer}>
          <View>
            ...
            <View style={styles.buttonRow}>
              ...
              >
                <Text
                  style={[styles.buttonText, listType === 'flat' ? styles.buttonTextActive : styles.buttonTextInactive]}
                >
                  FlatList
                </Text>
              </TouchableOpacity>
              ...
              <View style={styles.buttonRow}>
                ...
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'animated' ? styles.buttonTextActive : styles.buttonTextInactive,
                    ]}
                  >
                    Animated
                  </Text>
                ...
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'non-animated' ? styles.buttonTextActive : styles.buttonTextInactive,
                    ]}
                  >
                    Non-Animated
                  </Text>
                ...
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'header-footer' ? styles.buttonTextActive : styles.buttonTextInactive,
                    ]}
                  >
                    Header/Footer
                  </Text>
        ...
        {(() => {
          ...
          const containerStyle = {
            flex: 1,
            paddingTop:
              paddingType === 'non-animated' ? paddingValue : paddingType === 'animated' ? animatedPaddingValue : 0,
          };
