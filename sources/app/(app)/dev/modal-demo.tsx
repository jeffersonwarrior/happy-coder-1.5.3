...
export default function ModalDemoScreen() {
    ...
    Modal.alert('Multiple Actions', 'Choose an action:', [
      {
        text: 'Cancel',
        style: 'cancel',
        onPress: () => setLastResult('Pressed Cancel'),
      },
  ...
  const showDestructiveConfirm = async () => {
    const result = await Modal.confirm('Delete Item', 'This action cannot be undone. Are you sure?', {
      confirmText: 'Delete',
      cancelText: 'Keep',
      destructive: true,
    });
    ...
    <ScrollView style={styles.container}>
      ...
      <ItemList>
        <ItemGroup title="Alert Modals">
          <Item title="Simple Alert" subtitle="Basic alert with title only" onPress={showSimpleAlert} />
          <Item title="Alert with Message" subtitle="Alert with title and message" onPress={showAlertWithMessage} />
          <Item
        ...
        <ItemGroup title="Confirmation Modals">
          <Item title="Basic Confirmation" subtitle="Simple yes/no confirmation" onPress={showConfirm} />
          <Item
        ...
        <ItemGroup title="Custom Modals">
          <Item title="Custom Modal" subtitle="Fully custom modal component" onPress={showCustomModal} />
          <Item title="Multiple Modals" subtitle="Show multiple modals in sequence" onPress={showMultipleModals} />
        </ItemGroup>
