      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          <View style={[styles.qrContainer, { margin: 5 }]}>
            ...
            <QRCode data="Blue QR Code" size={150} foregroundColor="#0066CC" backgroundColor="#FFFFFF" />
          </View>
          <View style={[styles.qrContainer, { margin: 5 }]}>
            <Text style={styles.qrLabel}>White on Dark</Text>
            <QRCode data="White QR Code" size={150} foregroundColor="#FFFFFF" backgroundColor="#333333" />
          </View>
        </View>
      </View>
