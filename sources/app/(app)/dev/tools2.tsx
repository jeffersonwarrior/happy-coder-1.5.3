          ...
          results: [
            {
              file: 'App.tsx',
              line: 5,
              match: 'const [count, setCount] = useState(0);',
            },
            {
  ...
  const renderExample = (key: string, example: any) => {
    ...
    return (
      <View key={key} style={styles.exampleContainer}>
        ...
        <ToolView tool={example} metadata={null} onPress={() => console.log(`Pressed tool: ${key}`)} />
      </View>
    );
  };
    ...
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.description}>Examples of different tool calls and their visual representations</Text>

          <ItemGroup title="Filter Examples">
            <Item title="All Examples" selected={selectedExample === 'all'} onPress={() => setSelectedExample('all')} />
            <Item title="Read Tool" selected={selectedExample === 'read'} onPress={() => setSelectedExample('read')} />
            <Item title="Edit Tool" selected={selectedExample === 'edit'} onPress={() => setSelectedExample('edit')} />
            <Item title="Bash Tool" selected={selectedExample === 'bash'} onPress={() => setSelectedExample('bash')} />
            <Item
              title="Other Tools"
          ...
          <View style={styles.examplesSection}>
            ...
            {selectedExample === 'all' || selectedExample === 'edit' ? renderExample('edit', examples.edit) : null}
            ...
            {selectedExample === 'status' ? (
              <>
                ...
                <View style={styles.statusSection}>
                  <Text style={styles.statusDescription}>The following status icons are used in tool views:</Text>
                  {renderExample('bashRunning', {
                    ...examples.bashRunning,
                    name: 'Running State',
                  })}
                  {renderExample('bash', {
                    ...examples.bash,
