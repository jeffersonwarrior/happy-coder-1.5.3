      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.orientationBox}>
            <Ionicons name={rt.isPortrait ? 'phone-portrait' : 'phone-landscape'} size={24} color="white" />
        ...
        <View style={styles.section}>
          ...
          <Text style={{ marginBottom: 12, color: '#666' }}>Padding and border radius adapt to screen size</Text>
        ...
        <View style={styles.section}>
          ...
          {showRuntimeInfo && (
            <>
              ...
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Orientation: {rt.isPortrait ? 'Portrait' : 'Landscape'}</Text>
              </View>
              <View style={styles.runtimeBox}>
              ...
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Has Dynamic Island: {rt.insets.top > 50 ? 'Yes' : 'No'}</Text>
              </View>
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>
                  Safe Insets: T:{rt.insets.top} B:{rt.insets.bottom} L:
                  {rt.insets.left} R:{rt.insets.right}
                </Text>
              </View>
            </>
          )}
        ...
        >
          ...
          <Text style={{ color: '#856404', lineHeight: 20 }}>
            Unistyles compiles styles at build time and provides runtime optimizations. All the responsive features you
            see here work without performance penalties thanks to the native bridge integration.
          </Text>
        </View>
      </ScrollView>
    </View>
