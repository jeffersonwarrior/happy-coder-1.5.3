...
import { useRealtimeStatus, useSessionListViewData } from '@/sync/storage';
import { t } from '@/text';
    ...
    return (
      <>
        <View style={{ flex: 1, flexBasis: 0, flexGrow: 1 }}>
          ...
          {sessionListViewData !== null && sessionListViewData.length === 0 && <EmptyMainScreen />}
        </View>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        {!sessionListViewData || sessionListViewData.length === 0 ? (
          emptyState
        ) : (
          <>
            <PasswordMigrationBanner />
...
function NotAuthenticated() {
  ...
  const portraitLayout = (
    <View style={styles.portraitContainer}>
      <Image
        source={
          theme.dark ? require('@/assets/images/logotype-light.png') : require('@/assets/images/logotype-dark.png')
        }
        resizeMode="contain"
        style={styles.logo}
      />
      ...
      {Platform.OS !== 'android' && Platform.OS !== 'ios' ? (
        <>
          ...
          <View style={styles.buttonContainerSecondary}>
            <RoundButton size="normal" title={t('welcome.createAccount')} action={createAccount} display="inverted" />
          </View>
        </>
      ) : (
        <>
