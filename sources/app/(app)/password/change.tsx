  ...
  return (
    <ScrollView style={[styles.container, { paddingTop: safeArea.top }]} contentContainerStyle={styles.content}>
      ...
      <View style={styles.header}>
        <Ionicons name="key-outline" size={64} color={theme.colors.text} />
        <Text style={[styles.title, { color: theme.colors.text }]}>{t('password.changePassword')}</Text>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.inputGroup}>
          <Text style={[styles.label, { color: theme.colors.text }]}>{t('password.currentPassword')}</Text>
        ...
        <View style={styles.inputGroup}>
          ...
          {confirmPassword.length > 0 && (
            <View style={styles.matchContainer}>
              ...
              >
                {newPassword === confirmPassword ? t('password.passwordsMatch') : t('password.passwordMismatch')}
              </Text>
            </View>
          )}
        </View>
