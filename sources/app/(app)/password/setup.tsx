  ...
  return (
    <ScrollView style={[styles.container, { paddingTop: safeArea.top }]} contentContainerStyle={styles.content}>
      ...
      <View style={styles.header}>
        <Ionicons name="shield-checkmark-outline" size={64} color={theme.colors.text} />
        <Text style={[styles.title, { color: theme.colors.text }]}>{t('password.setupPassword')}</Text>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.inputGroup}>
          <Text style={[styles.label, { color: theme.colors.text }]}>{t('password.newPassword')}</Text>
        ...
        <View style={styles.inputGroup}>
          <Text style={[styles.label, { color: theme.colors.text }]}>{t('password.confirmPassword')}</Text>
          <View style={[styles.inputContainer, { borderColor: theme.colors.divider }]}>
            <TextInput
              style={[styles.input, { color: theme.colors.text }]}
          ...
          {confirmPassword.length > 0 && (
            <View style={styles.matchContainer}>
              ...
              >
                {password === confirmPassword ? t('password.passwordsMatch') : t('password.passwordMismatch')}
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Pressable style={styles.skipButton} onPress={handleSkip} disabled={isLoading}>
            <Text style={[styles.skipText, { color: theme.colors.textSecondary }]}>{t('password.skipForNow')}</Text>
          </Pressable>
        </View>
      </View>
    </ScrollView>
