...
import { getServerInfo, getServerUrl, setServerUrl, validateServerUrl } from '@/sync/serverConfig';
import { t } from '@/text';
...
export default function ServerConfigScreen() {
  ...
  const handleSave = async () => {
    ...
    const confirmed = await Modal.confirm(t('server.changeServer'), t('server.continueWithServer'), {
  ...
  const handleReset = async () => {
    const confirmed = await Modal.confirm(t('server.resetToDefault'), t('server.resetServerDefault'), {
        ...
        <ItemList style={styles.itemListContainer}>
          <ItemGroup footer={t('server.advancedFeatureFooter')}>
            <View style={styles.contentContainer}>
              ...
              {serverInfo.isCustom && <Text style={styles.statusText}>{t('server.currentlyUsingCustomServer')}</Text>}
            </View>
          </ItemGroup>
        </ItemList>
      </KeyboardAvoidingView>
