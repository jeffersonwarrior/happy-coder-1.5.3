...
import { MCPModel, mcpService } from '@/services/mcpService';
...
export default function FeaturesSettingsScreen() {
  ...
  const getDefaultCoderDisplay = () => {
    switch (defaultCoder) {
      case 'claude':
        return t('settingsFeatures.defaultCoderClaude');
      case 'codex':
        return t('settingsFeatures.defaultCoderCodex');
      case 'ask':
        return t('settingsFeatures.defaultCoderAsk');
      default:
        return t('settingsFeatures.defaultCoderClaude');
    }
  };
  ...
  return (
    <ItemList style={{ paddingTop: 0 }}>
      ...
      <ItemGroup title={t('settingsFeatures.experiments')} footer={t('settingsFeatures.experimentsDescription')}>
        <Item
      ...
      <ItemGroup title={t('settingsFeatures.defaultCoder')} footer={t('settingsFeatures.defaultCoderDescription')}>
        <Item
      ...
      {/* AI Models Discovery */}
      <ItemGroup title={t('settingsFeatures.aiModels')} footer={t('settingsFeatures.aiModelsDescription')}>
        {modelsLoading ? (
          <Item
      ...
      {/* Privacy Features */}
      <ItemGroup title={t('settingsFeatures.privacy')} footer={t('settingsFeatures.privacyDescription')}>
        <Item
          ...
          rightElement={<Switch value={anonymousMode} onValueChange={setAnonymousMode} />}
          showChevron={false}
        />
      </ItemGroup>
