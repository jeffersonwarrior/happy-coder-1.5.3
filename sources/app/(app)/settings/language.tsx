...
export default function LanguageSettingsScreen() {
  ...
  return (
    <ItemList style={{ paddingTop: 0 }}>
      <ItemGroup title={t('settingsLanguage.currentLanguage')} footer={t('settingsLanguage.description')}>
        {languageOptions.map(option => (
          <Item
            ...
            rightElement={
              currentSelection === option.key ? <Ionicons name="checkmark" size={20} color="#007AFF" /> : null
            }
