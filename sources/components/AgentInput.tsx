...
import { ActivityIndicator, Platform, Text, TouchableWithoutFeedback, useWindowDimensions, View } from 'react-native';
...
import { hapticsError, hapticsLight } from './haptics';
import { layout } from './layout';
import { KeyPressEvent, MultiTextInput, MultiTextInputHandle, TextInputState } from './MultiTextInput';
import { ModelMode, PermissionMode } from './PermissionModeSelector';
import { ShakeInstance, Shaker } from './Shaker';
...
export const AgentInput = React.memo(
  React.forwardRef<MultiTextInputHandle, AgentInputProps>((props, ref) => {
    ...
    const [suggestions, selected, moveUp, moveDown] = useActiveSuggestions(activeWord, props.autocompleteSuggestions, {
      clampSelection: true,
      wrapAround: true,
    });
      ...
      <View style={[styles.container, { paddingHorizontal: screenWidth > 700 ? 16 : 8 }]}>
        <View style={[styles.innerContainer, { maxWidth: layout.maxWidth }]}>
          ...
          {suggestions.length > 0 && (
            <View style={[styles.autocompleteOverlay, { paddingHorizontal: screenWidth > 700 ? 0 : 8 }]}>
                    ...
                    {(isCodex
                      ...
                      const modelConfig = isCodex
                        ...
                        : {
                            default: { label: t('agentInput.model.default') },
                            adaptiveUsage: {
                              label: t('agentInput.model.adaptiveUsage'),
                            },
            ...
            <View style={styles.actionButtonsContainer}>
              <View style={styles.actionButtonsLeft}>
                ...
                {props.machineName !== undefined && props.onMachineClick && (
                  ...
                  >
                    <Ionicons name="desktop-outline" size={14} color={theme.colors.button.secondary.tint} />
                    <Text
                      style={{
                        fontSize: 13,
                        color: theme.colors.button.secondary.tint,
