...
import { SessionListViewItem, storage, useSessionListViewData, useSetting } from '@/sync/storage';
    ...
    ({ item, index }: { item: SessionListViewItem & { selected?: boolean }; index: number }) => {
      switch (item.type) {
        ...
        case 'session': {
          ...
          const nextItem =
            index < (dataWithSelected?.length || 0) - 1 && dataWithSelected ? dataWithSelected[index + 1] : null;
        ...
        >
          ...
          <View style={styles.sessionContent}>
            ...
            <View style={styles.statusRow}>
              ...
              <Text style={[styles.statusText, { color: sessionStatus.statusColor }]}>{sessionStatus.statusText}</Text>
            </View>
          </View>
        </Pressable>
