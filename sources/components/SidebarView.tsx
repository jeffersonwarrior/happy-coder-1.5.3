...
import { useRealtimeStatus, useSessionListViewData, useSocketStatus } from '@/sync/storage';
import { t } from '@/text';
      ...
      <View style={[styles.container, { paddingTop: safeArea.top }]}>
        <View style={[styles.header, { height: headerHeight }]}>
          <View style={styles.logoContainer}>
            <Image
              source={
                theme.dark ? require('@/assets/images/logo-white.png') : require('@/assets/images/logo-black.png')
              }
              contentFit="contain"
          ...
          <View style={styles.titleContainer}>
            ...
            {getConnectionStatus().text && (
              <View style={styles.statusContainer}>
                ...
                />
                <Text style={[styles.statusText, { color: getConnectionStatus().textColor }]}>
                  {getConnectionStatus().text}
                </Text>
              </View>
            )}
        ...
        <View style={styles.contentContainer}>
          ...
          {sessionListViewData !== null && sessionListViewData.length > 0 && <SessionsList />}
        </View>
      </View>
