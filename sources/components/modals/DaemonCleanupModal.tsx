...
export function showDaemonCleanupModal(props: DaemonCleanupModalProps): void {
  ...
  const handleRemoveSession = async () => {
    try {
      ...
      Modal.alert(t('common.error'), error instanceof Error ? error.message : 'Failed to remove session');
    }
  };
  ...
  const handleForceStop = async () => {
    try {
      ...
      Modal.alert(t('common.error'), error instanceof Error ? error.message : 'Failed to force stop daemon');
    }
  };
  ...
  Modal.alert(t('daemonCleanup.unableToStop'), description, [
    {
