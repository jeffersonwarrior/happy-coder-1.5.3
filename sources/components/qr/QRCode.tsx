import { Canvas, DiffRect, Group, Path, Rect, RoundedRect, rect, rrect } from '@shopify/react-native-skia';
...
export const QRCode = React.memo((props: QRCodeProps) => {
  ...
  return (
    <Canvas style={{ width: size, height: size }}>
      {/* Background */}
      <RoundedRect x={0} y={0} width={size} height={size} color={backgroundColor} r={moduleSize * baseRadius * 3} />
