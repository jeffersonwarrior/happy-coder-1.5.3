...
import { KeyboardTypeOptions, Platform, Pressable, StyleSheet, Text, TextInput, View } from 'react-native';
    ...
    <BaseModal visible={true} onClose={handleCancel} closeOnBackdrop={false}>
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          {config.message && <Text style={[styles.message, Typography.default()]}>{config.message}</Text>}
          <TextInput
            ref={inputRef}
        ...
        <View style={styles.buttonContainer}>
          ...
          <Pressable style={({ pressed }) => [styles.button, pressed && styles.buttonPressed]} onPress={handleConfirm}>
            <Text style={[styles.buttonText, Typography.default('semiBold')]}>{config.confirmText || 'OK'}</Text>
          </Pressable>
        </View>
      </View>
    </BaseModal>
