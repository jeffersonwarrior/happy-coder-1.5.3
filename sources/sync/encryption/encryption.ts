...
import { AES256Encryption, Decryptor, Encryptor, SecretBoxEncryption } from './encryptor';
...
export class Encryption {
  static async create(masterSecret: Uint8Array) {
    ...
    // Derive anonymous ID
    const anonID = encodeHex(await deriveKey(masterSecret, 'Happy Coder', ['analytics', 'id']))
      .slice(0, 16)
      .toLowerCase();
