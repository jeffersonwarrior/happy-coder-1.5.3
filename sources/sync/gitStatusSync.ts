...
import { mergeDiffSummaries, parseNumStat } from './git-parsers/parseDiff';
import { getStatusCounts, isDirty, parseStatusSummary } from './git-parsers/parseStatus';
import {
  getCurrentBranchV2,
  getStatusCountsV2,
  getTrackingInfoV2,
...
import { createProjectKey, projectManager } from './projectManager';
