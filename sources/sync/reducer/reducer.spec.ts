...
describe('reducer', () => {
  ...
  describe('AgentState permissions', () => {
    ...
    it('should handle denied and canceled permissions correctly', () => {
      ...
      const deniedMsg = result2.messages.find(m => m.kind === 'tool-call' && m.tool.name === 'Write');
      const canceledMsg = result2.messages.find(m => m.kind === 'tool-call' && m.tool.name === 'Delete');
    ...
    it('should handle interleaved messages from multiple sources correctly', () => {
      ...
      const pendingPerm = result.messages.find(m => m.kind === 'tool-call' && m.tool.permission?.status === 'pending');
