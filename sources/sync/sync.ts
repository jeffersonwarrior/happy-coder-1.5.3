...
import { LogLevel, PaywallResult, RevenueCat } from './revenueCat';
...
class Sync {
  ...
  private fetchSessions = async () => {
    ...
    // Decrypt sessions
    const decryptedSessions: (Omit<Session, 'presence'> & {
        ...
        this.applySessions([
          {
            ...
            metadata,
            metadataVersion: updateData.body.metadata ? updateData.body.metadata.version : session.metadataVersion,
            updatedAt: updateData.createdAt,
            seq: updateData.seq,
          },
        ]);
