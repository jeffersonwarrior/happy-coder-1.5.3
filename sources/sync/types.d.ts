...
declare module 'expo-task-manager' {
  ...
  export type TaskManagerTaskExecutor = (task: TaskManagerTask) => Promise<void> | void;

  export function defineTask(taskName: string, task: TaskManagerTaskExecutor): void;
