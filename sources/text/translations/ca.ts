...
export const ca: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    defaultCoder: 'Codificador per defecte',
    defaultCoderDescription: "Tria quin assistent d'IA utilitzar per a noves sessions per defecte.",
    defaultCoderClaude: 'Claude Code',
    defaultCoderCodex: 'Codex',
    defaultCoderAsk: 'Preguntar cada vegada',
    privacy: 'Privacitat',
    privacyDescription: 'Controla com es mostra i comparteix la teva informació personal.',
    anonymousModeDisabled: 'Mostrar nom real i perfil',
    aiModels: "Models d'IA",
    aiModelsDescription:
      "Models d'IA descoberts automàticament i les seves capacitats. Toca per actualitzar la llista de models.",
    discoveringModels: "Descobrint models d'IA disponibles...",
    noModelsFound: "No s'han trobat models",
    noModelsFoundDescription: "Toca per cercar models d'IA disponibles",
    showMoreModels: (count: number) => `Mostra tots els ${count} models`,
    showLessModels: 'Mostra menys models',
    refreshModels: 'Actualitza la llista de models',
    refreshModelsDescription: "Descobreix models d'IA nous o actualitzats",
  },
  ...
  errors: {
    ...
    disconnectServiceFailed: ({ service }: { service: string }) => `Ha fallat la desconnexió de ${service}`,
  ...
  settingsAccount: {
    ...
    passwordSecurity: 'Seguretat de contrasenya',
    passwordSecurityDescription: "Protegeix les teves sessions amb una contrasenya per prevenir l'accés no autoritzat.",
    setupPasswordSubtitle: 'Afegir protecció amb contrasenya a les teves sessions',
    changePasswordSubtitle: 'Actualitzar la teva contrasenya actual',
    disablePasswordSubtitle: 'Eliminar la protecció amb contrasenya',
  },
  ...
  sessions: {
    ...
    deleteSessionMessage: ({ sessionName }: { sessionName: string }) =>
      `Esteu segur que voleu eliminar "${sessionName}"? Aquesta acció no es pot desfer.`,
  ...
  password: {
    ...
    unlockSession: 'Desbloqueja sessió',
    unlockSessionDescription: 'Introdueix la teva contrasenya per accedir a les teves sessions',
    enterPassword: 'Introdueix la teva contrasenya',
    unlock: 'Desbloqueja',
    verifying: 'Verificant...',
    error: 'Error de contrasenya',
    incorrectPassword: 'Contrasenya incorrecta',
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) =>
      `Contrasenya incorrecta. ${attempts === 1 ? 'Queda 1 intent' : `Queden ${attempts} intents`}.`,
    tooManyAttempts: 'Massa intents',
    tooManyAttemptsMessage:
      "Massa intents fallits de contrasenya. Prova amb autenticació biomètrica o restableix l'aplicació.",
    attemptsRemaining: ({ attempts }: { attempts: number }) =>
      attempts === 1 ? 'Queda 1 intent' : `Queden ${attempts} intents`,
    verificationError: "No s'ha pogut verificar la contrasenya. Si us plau, torna-ho a provar.",
    useBiometric: 'Utilitzar autenticació biomètrica',
    biometricPrompt: 'Utilitza la teva biometria per desbloquejar Happy Coder',
    biometricUnavailable: 'Biometria no disponible',
    biometricUnavailableMessage: "L'autenticació biomètrica no està disponible en aquest dispositiu.",
    biometricError: "L'autenticació biomètrica ha fallat. Si us plau, torna-ho a provar.",
    tryBiometric: 'Provar biometria',
    usePassword: 'Utilitzar contrasenya',
    forgotPassword: 'Has oblidat la contrasenya?',
    forgotPasswordMessage:
      "Oblidar la teva contrasenya restablirà l'aplicació i necessitaràs restaurar el teu compte utilitzant la teva clau secreta.",
    resetApp: 'Restablir aplicació',
    setupPassword: 'Configurar contrasenya',
    setupPasswordDescription: 'Protegeix les teves sessions amb una contrasenya',
    createPassword: 'Crear contrasenya',
    confirmPassword: 'Confirmar contrasenya',
    passwordMismatch: 'Les contrasenyes no coincideixen',
    passwordTooWeak: 'La contrasenya és massa feble',
    passwordCreated: 'Protecció amb contrasenya habilitada amb èxit',
    changePassword: 'Canviar contrasenya',
    currentPassword: 'Contrasenya actual',
    newPassword: 'Nova contrasenya',
    passwordChanged: 'Contrasenya canviada amb èxit',
    disablePassword: 'Desactivar protecció amb contrasenya',
    disablePasswordMessage:
      'Estàs segur que vols desactivar la protecció amb contrasenya? Les teves sessions seran accessibles sense contrasenya.',
    passwordDisabled: 'Protecció amb contrasenya desactivada',
    anonymousMode: 'Mode anònim',
    anonymousModeDescription: 'Utilitzar credencials temporals sense guardar informació del compte',
    enableAnonymousMode: 'Habilitar mode anònim',
    anonymousModeEnabled: 'Mode anònim habilitat. Les dades de la teva sessió no es guardaran.',
    passwordStrengthWeak: 'Feble',
    passwordStrengthMedium: 'Mitjana',
    passwordStrengthStrong: 'Forta',
    passwordsMatch: 'Les contrasenyes coincideixen',
    setup: 'Configurant',
    skipForNow: 'Ometre per ara',
    // Password recovery
    recoveryTitle: 'Recuperació de contrasenya',
    recoveryDescription: "Tria com vols recuperar l'accés al teu compte",
    biometricResetPrompt: "Autentica't per restablir la teva contrasenya",
    useOtherMethod: 'Utilitza un altre mètode',
    resetPasswordTitle: 'Restablir contrasenya',
    resetPasswordBiometric:
      'La teva identitat ha estat verificada. Això eliminarà la protecció per contrasenya mantenint les teves dades de sessió segures.',
    resetPassword: 'Restablir contrasenya',
    resetAppTitle: 'Restablir aplicació',
    resetAppWarning:
      'Això eliminarà TOTES les teves dades incloent sessions, configuració i informació del compte. Aquesta acció no es pot desfer.',
    resetAppDescription: 'Eliminar totes les dades i començar de nou',
    confirmReset: 'Estàs absolutament segur?',
    confirmResetMessage:
      'Això eliminarà tot permanentment. Necessitaràs restaurar el teu compte utilitzant la teva clau secreta.',
    yesResetEverything: 'Sí, restablir tot',
    passwordResetSuccess:
      'La protecció per contrasenya ha estat eliminada. Pots configurar una nova contrasenya a Configuració.',
    useFaceID: 'Utilitzar Face ID',
    useTouchID: 'Utilitzar Touch ID',
    biometricRecoveryDescription: 'Restablir contrasenya utilitzant autenticació biomètrica',
    useSecretKey: 'Utilitzar clau secreta',
    secretKeyRecoveryDescription: 'Restaurar el teu compte utilitzant la teva clau secreta de còpia de seguretat',
    recoveryFooter: 'Si necessites ajuda recuperant el teu compte, aquestes opcions et guiaran a través del procés.',
    backToUnlock: 'Tornar a la pantalla de desbloqueig',
    processing: 'Processant...',
  },

  passwordMigration: {
    // Password migration banner for existing users
    title: 'Protegeix les teves sessions',
    description:
      'Afegeix protecció amb contrasenya per mantenir segures les teves sessions de programació. Les teves dades romandran privades amb desbloqueig biomètric opcional.',
    setupNow: 'Configurar ara',
    learnMore: 'Saber-ne més',
    compactTitle: 'Activar protecció amb contrasenya',
  },
