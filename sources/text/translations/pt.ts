...
export const pt: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    defaultCoder: 'Codificador padrão',
    defaultCoderDescription: 'Escolha qual assistente de IA usar para novas sessões por padrão.',
    defaultCoderClaude: 'Claude Code',
    defaultCoderCodex: 'Codex',
    defaultCoderAsk: 'Perguntar toda vez',
    privacy: 'Privacidade',
    privacyDescription: 'Controle como suas informações pessoais são exibidas e compartilhadas.',
    anonymousModeDisabled: 'Mostrar nome real e perfil',
    aiModels: 'Modelos de IA',
    aiModelsDescription:
      'Modelos de IA descobertos automaticamente e suas capacidades. Toque para atualizar a lista de modelos.',
    discoveringModels: 'Descobrindo modelos de IA disponíveis...',
    noModelsFound: 'Nenhum modelo encontrado',
    noModelsFoundDescription: 'Toque para procurar modelos de IA disponíveis',
    showMoreModels: (count: number) => `Mostrar todos os ${count} modelos`,
    showLessModels: 'Mostrar menos modelos',
    refreshModels: 'Atualizar lista de modelos',
    refreshModelsDescription: 'Descobrir modelos de IA novos ou atualizados',
  },
  ...
  errors: {
    ...
    errorWithCode: ({ message, code }: { message: string; code: number | string }) => `${message} (Erro ${code})`,
    disconnectServiceFailed: ({ service }: { service: string }) => `Falha ao desconectar ${service}`,
  ...
  settingsAccount: {
    ...
    passwordSecurityDescription: 'Proteja suas sessões com uma senha para prevenir acesso não autorizado.',
    setupPasswordSubtitle: 'Adicionar proteção por senha às suas sessões',
    changePasswordSubtitle: 'Atualizar sua senha atual',
    disablePasswordSubtitle: 'Remover proteção por senha',
  },
  ...
  sessions: {
    ...
    deleteSessionMessage: ({ sessionName }: { sessionName: string }) =>
      `Tem certeza de que deseja excluir "${sessionName}"? Esta ação não pode ser desfeita.`,
    renameSessionTitle: 'Renomear sessão',
    renameSessionMessage: 'Digite um novo nome para esta sessão:',
    sessionNamePlaceholder: 'Digite o nome da sessão...',
    duplicatePrefix: ({ originalName }: { originalName: string }) => `Cópia de ${originalName}`,
    sessionIdCopied: 'ID da sessão copiado para a área de transferência',
    failedToCopySessionId: 'Falha ao copiar o ID da sessão',
    exportSaved: ({ fileName }: { fileName: string }) => `Histórico da sessão salvo como ${fileName}`,
    exportFailed: 'Falha ao exportar o histórico da sessão',
  ...
  password: {
    ...
    unlockSessionDescription: 'Digite sua senha para acessar suas sessões',
    ...
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) =>
      `Senha incorreta. ${attempts === 1 ? 'Resta 1 tentativa' : `Restam ${attempts} tentativas`}.`,
    tooManyAttempts: 'Muitas tentativas',
    tooManyAttemptsMessage:
      'Muitas tentativas de senha falhadas. Tente autenticação biométrica ou redefina o aplicativo.',
    attemptsRemaining: ({ attempts }: { attempts: number }) =>
      attempts === 1 ? 'Resta 1 tentativa' : `Restam ${attempts} tentativas`,
    verificationError: 'Não foi possível verificar a senha. Por favor, tente novamente.',
    useBiometric: 'Usar autenticação biométrica',
    biometricPrompt: 'Use sua biometria para desbloquear o Happy Coder',
    biometricUnavailable: 'Biometria indisponível',
    biometricUnavailableMessage: 'A autenticação biométrica não está disponível neste dispositivo.',
    biometricError: 'A autenticação biométrica falhou. Por favor, tente novamente.',
    tryBiometric: 'Tentar biometria',
    usePassword: 'Usar senha',
    forgotPassword: 'Esqueceu sua senha?',
    forgotPasswordMessage:
      'Esquecer sua senha redefinirá o aplicativo e você precisará restaurar sua conta usando sua chave secreta.',
    resetApp: 'Redefinir aplicativo',
    setupPassword: 'Configurar senha',
    setupPasswordDescription: 'Proteja suas sessões com uma senha',
    createPassword: 'Criar senha',
    confirmPassword: 'Confirmar senha',
    passwordMismatch: 'As senhas não coincidem',
    passwordTooWeak: 'A senha é muito fraca',
    passwordCreated: 'Proteção por senha habilitada com sucesso',
    changePassword: 'Alterar senha',
    currentPassword: 'Senha atual',
    newPassword: 'Nova senha',
    passwordChanged: 'Senha alterada com sucesso',
    disablePassword: 'Desativar proteção por senha',
    disablePasswordMessage:
      'Tem certeza de que deseja desativar a proteção por senha? Suas sessões serão acessíveis sem senha.',
    passwordDisabled: 'Proteção por senha desativada',
    anonymousMode: 'Modo anônimo',
    anonymousModeDescription: 'Usar credenciais temporárias sem salvar informações da conta',
    enableAnonymousMode: 'Habilitar modo anônimo',
    anonymousModeEnabled: 'Modo anônimo habilitado. Os dados da sua sessão não serão salvos.',
    ...
    recoveryDescription: 'Escolha como você gostaria de recuperar o acesso à sua conta',
    biometricResetPrompt: 'Autentique-se para redefinir sua senha',
    useOtherMethod: 'Usar outro método',
    resetPasswordTitle: 'Redefinir senha',
    resetPasswordBiometric:
      'Sua identidade foi verificada. Isso removerá a proteção por senha mantendo seus dados de sessão seguros.',
    resetPassword: 'Redefinir senha',
    resetAppTitle: 'Redefinir aplicativo',
    resetAppWarning:
      'Isso excluirá TODOS os seus dados incluindo sessões, configurações e informações da conta. Esta ação não pode ser desfeita.',
    resetAppDescription: 'Remover todos os dados e começar do zero',
    confirmReset: 'Você tem certeza absoluta?',
    confirmResetMessage:
      'Isso excluirá tudo permanentemente. Você precisará restaurar sua conta usando sua chave secreta.',
    yesResetEverything: 'Sim, redefinir tudo',
    passwordResetSuccess: 'A proteção por senha foi removida. Você pode configurar uma nova senha nas Configurações.',
    useFaceID: 'Usar Face ID',
    useTouchID: 'Usar Touch ID',
    biometricRecoveryDescription: 'Redefinir senha usando autenticação biométrica',
    useSecretKey: 'Usar chave secreta',
    secretKeyRecoveryDescription: 'Restaurar sua conta usando sua chave secreta de backup',
    recoveryFooter:
      'Se você precisar de ajuda para recuperar sua conta, essas opções irão guiá-lo através do processo.',
    backToUnlock: 'Voltar à tela de desbloqueio',
    processing: 'Processando...',
  },

  passwordMigration: {
    // Password migration banner for existing users
    title: 'Proteja suas sessões',
    description:
      'Adicione proteção por senha para manter suas sessões de programação seguras. Seus dados permanecerão privados com desbloqueio biométrico opcional.',
    setupNow: 'Configurar agora',
    learnMore: 'Saiba mais',
    compactTitle: 'Ativar proteção por senha',
  },
