...
export const zhHans = {
  ...
  settingsFeatures: {
    ...
    defaultCoder: '默认编码器',
    defaultCoderDescription: '选择新会话默认使用的AI助手。',
    defaultCoderClaude: 'Claude Code',
    defaultCoderCodex: 'Codex',
    defaultCoderAsk: '每次询问',
    privacy: '隐私',
    privacyDescription: '控制您的个人信息如何显示和共享。',
    anonymousModeDisabled: '显示真实姓名和个人资料',
    aiModels: 'AI 模型',
    aiModelsDescription: '自动发现的 AI 模型及其功能。点击刷新模型列表。',
    discoveringModels: '正在发现可用的 AI 模型...',
    noModelsFound: '未找到模型',
    noModelsFoundDescription: '点击搜索可用的 AI 模型',
    showMoreModels: (count: number) => `显示所有 ${count} 个模型`,
    showLessModels: '显示更少模型',
    refreshModels: '刷新模型列表',
    refreshModelsDescription: '发现新的或更新的 AI 模型',
  },
  ...
  errors: {
    ...
    errorWithCode: ({ message, code }: { message: string; code: number | string }) => `${message} (错误 ${code})`,
  ...
  settingsAccount: {
    ...
    passwordSecurityDescription: '使用密码保护您的会话，防止未经授权的访问。',
    setupPasswordSubtitle: '为您的会话添加密码保护',
    changePasswordSubtitle: '更新您当前的密码',
    disablePasswordSubtitle: '移除密码保护',
  },
  ...
  modals: {
    ...
    disconnectServiceConfirm: ({ service }: { service: string }) => `您确定要断开 ${service} 与您账户的连接吗？`,
    disconnect: '断开连接',
  ...
  password: {
    ...
    unlockSession: '解锁会话',
    unlockSessionDescription: '输入密码以访问您的会话',
    enterPassword: '输入密码',
    unlock: '解锁',
    verifying: '验证中...',
    error: '密码错误',
    incorrectPassword: '密码错误',
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) => `密码错误。剩余${attempts}次尝试机会。`,
    tooManyAttempts: '尝试次数过多',
    tooManyAttemptsMessage: '密码尝试失败次数过多。请尝试生物识别认证或重置应用。',
    attemptsRemaining: ({ attempts }: { attempts: number }) => `剩余${attempts}次尝试机会`,
    verificationError: '无法验证密码。请重试。',
    useBiometric: '使用生物识别认证',
    biometricPrompt: '使用生物识别解锁 Happy Coder',
    biometricUnavailable: '生物识别不可用',
    biometricUnavailableMessage: '此设备不支持生物识别认证。',
    biometricError: '生物识别认证失败。请重试。',
    tryBiometric: '尝试生物识别',
    usePassword: '使用密码',
    forgotPassword: '忘记密码？',
    forgotPasswordMessage: '忘记密码将重置应用，您需要使用密钥恢复账户。',
    resetApp: '重置应用',
    setupPassword: '设置密码',
    setupPasswordDescription: '使用密码保护您的会话',
    createPassword: '创建密码',
    confirmPassword: '确认密码',
    passwordMismatch: '密码不匹配',
    passwordTooWeak: '密码强度太弱',
    passwordCreated: '密码保护已成功启用',
    changePassword: '更改密码',
    currentPassword: '当前密码',
    newPassword: '新密码',
    passwordChanged: '密码更改成功',
    disablePassword: '禁用密码保护',
    disablePasswordMessage: '您确定要禁用密码保护吗？您的会话将无需密码即可访问。',
    passwordDisabled: '密码保护已禁用',
    anonymousMode: '匿名模式',
    anonymousModeDescription: '使用临时凭据，不保存账户信息',
    enableAnonymousMode: '启用匿名模式',
    anonymousModeEnabled: '匿名模式已启用。您的会话数据将不会被保存。',
    ...
    // Password recovery
    recoveryTitle: '密码恢复',
    recoveryDescription: '选择您想要恢复账户访问的方式',
    biometricResetPrompt: '进行身份验证以重置密码',
    useOtherMethod: '使用其他方式',
    resetPasswordTitle: '重置密码',
    resetPasswordBiometric: '您的身份已验证。这将移除密码保护，同时保持您的会话数据安全。',
    resetPassword: '重置密码',
    resetAppTitle: '重置应用',
    resetAppWarning: '这将删除所有数据，包括会话、设置和账户信息。此操作无法撤销。',
    resetAppDescription: '删除所有数据并重新开始',
    confirmReset: '您确定吗？',
    confirmResetMessage: '这将永久删除所有内容。您需要使用密钥恢复您的账户。',
    yesResetEverything: '是的，重置所有内容',
    passwordResetSuccess: '密码保护已移除。您可以在设置中设置新密码。',
    useFaceID: '使用面容 ID',
    useTouchID: '使用触控 ID',
    biometricRecoveryDescription: '使用生物识别认证重置密码',
    useSecretKey: '使用密钥',
    secretKeyRecoveryDescription: '使用备份密钥恢复您的账户',
    recoveryFooter: '如果您需要恢复账户的帮助，这些选项将指导您完成整个过程。',
    backToUnlock: '返回解锁界面',
    processing: '处理中...',
  },
  ...
  passwordMigration: {
    ...
    title: '保护您的会话',
    description: '添加密码保护以确保您的编码会话安全。您的数据将保持私密，并可选择生物识别解锁。',
    setupNow: '立即设置',
    learnMore: '了解更多',
    compactTitle: '启用密码保护',
  },
  ...
  artifacts: {
    ...
    notFound: '工件未找到',
    discardChanges: '放弃更改？',
    discardChangesDescription: '您有未保存的更改，确定要放弃吗？',
    deleteConfirm: '删除工件？',
    deleteConfirmDescription: '此操作无法撤销',
    titleLabel: '标题',
    titlePlaceholder: '为您的工件输入标题',
    bodyLabel: '内容',
    bodyPlaceholder: '在这里编写您的内容...',
