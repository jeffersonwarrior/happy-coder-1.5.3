...
describe('pathUtils', () => {
  describe('resolveAbsolutePath', () => {
    describe('basic tilde expansion', () => {
      ...
      it('should expand ~/Documents/deep/nested/path', () => {
        expect(resolveAbsolutePath('~/Documents/deep/nested/path', '/Users/steve')).toBe(
          '/Users/steve/Documents/deep/nested/path'
        );
      });
    });
  ...
  describe('resolvePath (existing function)', () => {
    ...
    it('should not resolve sibling directory paths that start with metadata path', () => {
      ...
      expect(resolvePath('/Users/steve/Develop/slopus/happy-server/sources/types/index.ts', metadata)).toBe(
        '/Users/steve/Develop/slopus/happy-server/sources/types/index.ts'
      );
    });
    ...
    it('should handle edge case where metadata path is a substring of another path', () => {
      ...
      expect(resolvePath('/home/user/app-v2/src/main.js', metadata)).toBe('/home/user/app-v2/src/main.js');
      expect(resolvePath('/home/user/application/config.json', metadata)).toBe('/home/user/application/config.json');
    });
  });
