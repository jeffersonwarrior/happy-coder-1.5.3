...
describe('compareToolCalls', () => {
  it('should return true for identical tool calls', () => {
    const tool1 = {
      name: 'Read',
      arguments: { file_path: '/test.ts', limit: 10 },
    };
    const tool2 = {
      name: 'Read',
      arguments: { file_path: '/test.ts', limit: 10 },
  ...
  it('should handle null and undefined arguments', () => {
    expect(compareToolCalls({ name: 'Test', arguments: null }, { name: 'Test', arguments: null })).toBe(true);

    expect(compareToolCalls({ name: 'Test', arguments: undefined }, { name: 'Test', arguments: undefined })).toBe(true);

    expect(compareToolCalls({ name: 'Test', arguments: null }, { name: 'Test', arguments: undefined })).toBe(false);
  });
  ...
  it('should handle empty objects and arrays', () => {
    expect(compareToolCalls({ name: 'Test', arguments: {} }, { name: 'Test', arguments: {} })).toBe(true);
