...
import { hasToolUseError, isCancelError, parseAllToolUseErrors, parseToolUseError } from './toolErrorParser';
...
describe('toolErrorParser', () => {
  ...
  describe('isCancelError', () => {
    ...
    it('should return false for non-cancellation errors', () => {
      const regularErrors = ['File not found', 'Permission denied', 'Network error', 'Invalid input', 'Syntax error'];
